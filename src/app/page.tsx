...
import { CantileverGateCalculatorForm } from '@/components/calculators/cantilever-gate-calculator-form';
...
import { Fence, Scissors, Scale, TreePine, LayoutPanelLeft, BarChartHorizontalBig, Layers, Wrench, CircleDot, Shapes, ChevronsRightLeft } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Tabs defaultValue="chainlink" className="w-full">
          <TabsList className="grid w-full grid-cols-3 sm:grid-cols-4 md:grid-cols-10 gap-2 mb-6 h-auto flex-wrap justify-start">
            ...
            <TabsTrigger value="cantilever" className="flex-grow data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              <ChevronsRightLeft className="mr-2 h-4 w-4" /> Cantilever
            </TabsTrigger>
          ...
          <TabsContent value="cantilever">
            <CantileverGateCalculatorForm />
          </TabsContent>
